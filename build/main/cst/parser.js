...
var Parser = (function () {
    ...
    Parser.prototype.pushNonTerminal = function (type, dfa, beginTokens, newState, begin, end, line) {
        ...
        var newnode = { type: type, value: null, range: new Range_1.Range(beginPos, endPos), children: [] };
...
function makeParser(sourceKind) {
    ...
    switch (sourceKind) {
        case SourceKind.File: {
            p.setup(tables_2.ParseTables.sym.Start);
            break;
        }
        default: {
    ...
    var column = 0;
    var prefix = "";
    var tokenizer = new Tokenizer_1.Tokenizer(false /*sourceKind === SourceKind.Single*/, function tokenizerCallback(type, value, start, end, line) {
